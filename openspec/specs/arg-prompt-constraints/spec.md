# arg-prompt-constraints Specification

## Purpose
Defines declarative prompt constraints that script authors can attach to each `args` entry in the manifest. The CLI enforces these constraints in the TUI before executing the script.
